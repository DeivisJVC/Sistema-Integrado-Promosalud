...
<html lang="en">
  ...
  <body>
          ...
          <div class="modal-body modal_profile">
            <div class="d-flex flex-column align-items-center gap-3">
              <div class="text-center w-100">
                ...
                <a href="/edit-profile.html" class="btn btn-dark w-50 mt-3"
                  >Editar</a
                >
              </div>
            </div>
    ...
    <main class="container-sm mt-5 pt-5 mb-5">
      <h1 class="text-center">Generador de Informes de Salud</h1>
      <!--Formulario para seleccionar la empresa-->
      <!-- Formulario de seleccion de datos-->
      <section class="card p-4 my-4">
        <h5 class="mb-3">Seleccionar rango de fechas</h5>
        <form id="dateForm" class="needs-validation" novalidate>
          <div class="row">
            <div class="col-md-5">
              <label for="empresa" class="form-label">Empresa</label>
              <select class="form-select" id="empresa" required>
                <option value="seleccion" class="form-select-option">
                  Seleccione...
                </option>
                <option value="1" class="form-select-option">Empresa 1</option>
                <option value="2" class="form-select-option">Empresa 2</option>
                <option value="3" class="form-select-option">Empresa 3</option>
                <option value="4" class="form-select-option">Empresa 4</option>
                <option value="5" class="form-select-option">Empresa 5</option>
              </select>
      ...
      <!--Panel para descargar los informenes de salud-->
      <section class="card mb-4">
        ...
        <div class="card-body">
          <button
            ...
            onclick="download_informenes()"
            type="button"
          >
            Descargar Informe de salud PDF
          </button>
          <button class="btn btn-success" type="button">
            Descargar Informe de salud Excel
          </button>
        </div>
      </section>
    ...
    <script src="/assets/js/validacionInformenesSalud.js"></script>
  </body>
</html>
